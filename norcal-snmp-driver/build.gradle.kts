...
ignitionModule {
     ...
     */
    hooks.putAll(mapOf(
        "net.norcalcontrols.driver.snmp.gateway.NorcalSNMPDriverGatewayHook" to "G",
        "net.norcalcontrols.driver.snmp.client.NorcalSNMPDriverClientHook" to "C",
        "net.norcalcontrols.driver.snmp.designer.NorcalSNMPDriverDesignerHook" to "D"
    ))
