...
ignitionModule {
     ...
     */
    hooks.putAll(mapOf(
        "io.cursor.snmp.gateway.CursorSNMPGatewayHook" to "G",
        "io.cursor.snmp.client.CursorSNMPClientHook" to "C",
        "io.cursor.snmp.designer.CursorSNMPDesignerHook" to "D"
    ))
